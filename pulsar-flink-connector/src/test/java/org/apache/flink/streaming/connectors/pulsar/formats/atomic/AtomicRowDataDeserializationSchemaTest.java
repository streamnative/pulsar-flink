...
public class AtomicRowDataDeserializationSchemaTest extends TestLogger {
    ...
    public static Object[][] data() {
        return new Object[][] {
            new Object[] {Schema.INT8, Byte.MAX_VALUE},
            new Object[] {Schema.INT16, Short.MAX_VALUE},
            new Object[] {Schema.INT32, Integer.MAX_VALUE},
            new Object[] {Schema.INT64, Long.MAX_VALUE},
            new Object[] {Schema.DOUBLE, Double.MAX_VALUE},
            new Object[] {Schema.FLOAT, Float.MAX_VALUE},
            new Object[] {Schema.BYTES, new byte[] {1, 2, 3, 5, 6, 8, 9, 0}},
            new Object[] {Schema.STRING, "text"},
            new Object[] {Schema.LOCAL_DATE, LocalDate.now()},
            new Object[] {Schema.LOCAL_DATE_TIME, LocalDateTime.now()},
            new Object[] {Schema.LOCAL_TIME, LocalTime.now()},
            new Object[] {Schema.INSTANT, Instant.now()},
        };
    }
    ...
    public void deserialize() throws IOException {
        final AtomicRowDataDeserializationSchema deserializationSchema =
                new AtomicRowDataDeserializationSchema.Builder(expectedValue.getClass().getName())
                        .build();
    ...
    public void serialize() throws IOException {
        final AtomicRowDataSerializationSchema serializationSchema =
                new AtomicRowDataSerializationSchema.Builder(expectedValue.getClass().getName())
                        .build();
