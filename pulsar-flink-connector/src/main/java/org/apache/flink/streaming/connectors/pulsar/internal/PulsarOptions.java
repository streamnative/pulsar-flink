...
public class PulsarOptions {
    ...
    public static final String PULSAR_CLIENT_OPTION_KEY_PREFIX =
            PULSAR_OPTION_KEY_PREFIX + "client.";
    public static final String PULSAR_PRODUCER_OPTION_KEY_PREFIX =
            PULSAR_OPTION_KEY_PREFIX + "producer.";
    public static final String PULSAR_READER_OPTION_KEY_PREFIX =
            PULSAR_OPTION_KEY_PREFIX + "reader.";
    ...
    public static final Set<String> TOPIC_OPTION_KEYS =
            ImmutableSet.of(
                    TOPIC_SINGLE_OPTION_KEY, TOPIC_MULTI_OPTION_KEY, TOPIC_PATTERN_OPTION_KEY);
    ...
    public static final String PARTITION_DISCOVERY_INTERVAL_MS_OPTION_KEY =
    ...
    public static final Set<String> META_FIELD_NAMES =
            ImmutableSet.of(
