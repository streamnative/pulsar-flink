...
//                    new FlinkPulsarSource<String>("sev", "admin", new PulsarPrimitiveSchema<>(String.class), props).setStartFromEarliest();
//
...
//        stream.addSink(new AssertSink(serviceUrl, adminUrl, 7, sinkProp, SCHEMA.toPhysicalRowDataType()));
//        see.execute("write with topics");
//    }
//
//    @Test(timeout = 40 * 1000L)
...
//
//
//        PulsarDeserializationSchema<RowData> pulsarRowDeserializationSchema = PulsarDeserializationSchema.<RowData>builder()
//                .setDataType(SCHEMA.toPhysicalRowDataType())
//                .setValueDeserializer(getJsonRowDataDerSchema(ROW_TYPE))
//                .build();
//
...
//        FlinkPulsarSource<SchemaData.Foo> source =
//                new FlinkPulsarSource<>(serviceUrl, adminUrl,
//                        new PulsarDeserializationSchemaWrapper(JsonDeser.of(SchemaData.Foo.class),DataTypeUtils.toDataType(SchemaData.Foo.class)), sourceProps)
//                        .setStartFromEarliest();
//
//        DataStream<Integer> ds = see.addSource(source)
//                .map(SchemaData.Foo::getI);
...
//
//        DataStream stream = see.addSource(
//                new FlinkPulsarSource<>(serviceUrl, adminUrl, new PulsarPrimitiveSchema<>(Integer.class), sourceProps).setStartFromEarliest());
//
...
//                getJsonRowDataDerSchema(intRowTypeInfo()),
//                true,
//                getTopicConverters(),
...
//            rowData.setField(1, StringData.fromString(tp));
//            return rowData;
//        }
//
//        @Override
...
//        props.setProperty(FLUSH_ON_CHECKPOINT_OPTION_KEY, "true");
//        SerializationSchema<RowData> serializationSchema = getJsonSerializationSchema(ROW_TYPE);
//        PulsarSerializationSchema<RowData> pulsarRowSerializationSchema = new PulsarSerializationSchemaWrapper.Builder<>(serializationSchema)
//                .useRowMode(SCHEMA.toPhysicalRowDataType(), RecordSchemaType.JSON)
//                .setTopicExtractor((SerializableFunction<RowData, String>) row -> (String) row.getString(1).toString())
//                .build();
//
//
//
//        stream.addSink(
//                new FlinkPulsarSink<RowData>(
//                        serviceUrl,
//                        adminUrl,
//                        Optional.empty(),
//                        props,
...
//                    Optional.empty(),
//                    properties,
//                    new PulsarSerializationSchemaWrapper.Builder<>(getJsonSerializationSchema(ROW_TYPE))
//                    .setTopicExtractor((SerializableFunction<RowData, String>) row -> (String) row.getString(1).toString())
...
//            String topic = (String) value.getString(topicPos);
