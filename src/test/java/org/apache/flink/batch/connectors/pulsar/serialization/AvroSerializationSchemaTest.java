...
public class AvroSerializationSchemaTest {
    ...
    public void testAvroSerializationSchemaWithSuccessfulCase() throws IOException {
        NasaMission nasaMission =
                NasaMission.newBuilder()
                        .setId(1).setName("Mercury program").setStartYear(1959).setEndYear(1963).build();
        ...
        AvroDeserializationSchema<GenericRecord> deserializationSchema =
                AvroDeserializationSchema.forGeneric(nasaMission.getSchema());
    ...
    public void testAvroSerializationSchemaWithEmptyRecord() throws IOException {
        NasaMission nasaMission =
                NasaMission.newBuilder()
                        .setId(1).setName("Mercury program").setStartYear(null).setEndYear(null).build();
        AvroSerializationSchema schema = new AvroSerializationSchema();
        byte[] rowBytes = schema.serialize(nasaMission);
