...
public interface PulsarDeserializationSchema<T> extends PulsarContextAware<T>, Serializable {
     ...
     * @return A {@link PulsarDeserializationSchema} that deserialize the value with the given
     *     deserializer.
     */
    static <V> PulsarDeserializationSchema<V> valueOnly(
            DeserializationSchema<V> valueDeserializer) {
