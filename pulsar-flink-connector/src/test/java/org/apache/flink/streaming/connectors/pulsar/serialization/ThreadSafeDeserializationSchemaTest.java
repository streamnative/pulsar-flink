...
public class ThreadSafeDeserializationSchemaTest {
    ...
    public void deserialize() throws InterruptedException {
        NoThreadSafeDeserializationSchema noThreadSafeDeserializationSchema =
                new NoThreadSafeDeserializationSchema();
        DeserializationSchema deserializationSchema =
                ThreadSafeDeserializationSchema.of(noThreadSafeDeserializationSchema);
